...
import { StatCard, Card, CardHeader, CardTitle, CardContent, Badge, Avatar, Skeleton } from "@/components/ui";
import {
  Users, Radio, Music2, Download, TrendingUp,
  Clock, Activity, Disc3,
} from "lucide-react";
...
export default function DashboardPage() {
  ...
  return (
    <div>
      <Topbar title="Overview" subtitle="Welcome back — here's what's happening" />
            ...
            <CardContent>
              {loading ? (
                ...
                <ResponsiveContainer width="100%" height={200}>
                  <BarChart data={data?.channelStats ?? []} margin={{ left: -20 }}>
                    ...
                    />
                    <Bar dataKey="songsCount" fill="#ef4444" radius={[6, 6, 0, 0]} name="Songs" />
                  </BarChart>
                </ResponsiveContainer>
              )}
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              {loading ? (
                ...
                <ResponsiveContainer width="100%" height={200}>
                  <LineChart data={data?.downloadTrend ?? []} margin={{ left: -30 }}>
                  ...
                  {(data?.recentSongs ?? []).map((song: any) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-zinc-500 font-mono truncate">{song.artist}</p>
                      </div>
                      <div className="text-right shrink-0">
